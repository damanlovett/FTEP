...
class UsersController extends AppController {
	...
	function beforeFilter(){
        ...
        $this->Auth->allow('add','registration');
	...
	function index() {
		...
		$admins = $this->User->query('CALL admins();');
		$this->set('users', $this->paginate('User', array('User.group_id >'=>1)));
		//$this->set('users', $this->paginate($admins));
	}
