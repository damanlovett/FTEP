...
<br /><br />(7) Superior - Utilizes off-duty time to further professional knowledge and improve skills. Demonstrates concern for community education. Maintains high ideals in terms of professional responsibilities.'/></div>";
		...
		echo $this->Form->input('3', array('label'=>'3 Attitude Towards EMS Work', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='4. KNOWLEDGE OF POLICIES PROCEDURES - Evaluates the new employee knowledge of departmental procedures and ability to apply this knowledge under field conditions. Reflected by Testing (1) Unacceptable - When tested, verbally or written, answers with 69% or less accuracy. (4) Acceptable - When tested, verbally or written, answers with over 70% accuracy. <br /><br />(7) Superior - When tested, verbally or written, answers with 100% accuracy.-Reflected in Field Performance- <br /><br />(1) Unacceptable - Fails to display knowledge of department policies/regulation/procedures or violates same. (4) Acceptable - Familiar with most commonly applied department policies/regulation/procedures, including lesser-known and seldom used ones. <br /><br />(7) Superior - Familiar with all department policies. Including lesser used policies.'/></div>";
		...
		echo $this->Form->input('4p', array('label'=>'Delete?? Knowledge of Divisional Standards', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='5. KNOWLEDGE OF CARDIAC PROTOCOLS - Evaluates the new employee knowledge of the ACLS protocols and ability to apply that knowledge in field situations.
-Reflected by Testing-
<br /><br />(1) Unacceptable - When tested, verbally or written, answers with 69% or less accuracy.

<br /><br />(4) Acceptable - When tested, verbally or written, answers with over 70% accuracy.

<br /><br />(7) Superior - When tested, verbally or written, answers with 100% accuracy.

-Reflected in Field Performance-
(1) Unacceptable - Does not know the elements of algorithms. Does not recognize rhythm strips when encountered or makes mistakes relative to whether or not treatment should be given.
(4) Acceptable - Recognizes commonly encountered algorithms and applies appropriate treatment. Know difference between when to treat and when not to treat.
<br /><br />(7) Superior - Has outstanding knowledge of algorithms and applies that knowledge to normal and unusual cardiac calls.'/></div>";
		...
		echo $this->Form->input('5p', array('label'=>'Knowledge of Cardiac Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='6 KNOWLEDGE OF TRAUMA PROTOCOLS - Evaluates the new employees knowledge of local trauma protocols and ability to apply that knowledge to field situations.
-Reflected by Testing-
<br /><br />(1) Unacceptable - When tested, verbally or written, answers with 69% or less accuracy.

(4) Acceptable - When tested, verbally or written, answers with over 70% accuracy.

<br /><br />(7) Superior - When tested, verbally or written, answers with 100% accuracy.

-Reflected in Field Performance-
<br /><br />(1) Unacceptable - Does not know even the most common trauma system entry criteria. Confuses trauma entry criteria. Does not recognize trauma patient for entry.
<br /><br />(4) Acceptable - Knows and recognizes commonly encountered trauma system entry criteria. Applies appropriate trauma entry criteria and delivers appropriate care
<br /><br />(7) Superior - Has outstanding knowledge of trauma system entry criteria and delivers outstanding care.'/></div>";
																	

		echo $this->Form->input('6t', array('label'=>'Delete?? Knowledge of Trauma Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
		...
		echo $this->Form->input('6p', array('label'=>'Delete?? Knowledge of Trauma Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='7. KNOWLEDGE OF MEDICAL PROTOCOLS- Evaluates the new employees knowledge of local Medical Protocols and ability to apply that knowledge to field situations.
...
-Reflected in Field Performance-
<br /><br />(1) Unacceptable - Does not know even the most often used Medical Protocols. Does not recognize emergent patient conditions and incorrectly treats or fails to treat.

(4) Acceptable - Knows and recognizes commonly used medical protocols. Applies appropriate protocol. Can treat appropriately.

<br /><br />(7) Superior - Displays outstanding knowledge of all medical protocols. Quickly and effectively applies treatment protocols.'/></div>";
																	

		echo $this->Form->input('7t', array('label'=>'Delete?? Knowledge of Medical Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
		...
		echo $this->Form->input('7p', array('label'=>'Delete?? Knowledge of Medical Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='8. KNOWLEDGE OF PHARMACOLOGY- Evaluates the new employees knowledge of local medication protocols and has the ability to apply that knowledge to field situations.
-Reflected by Testing-
<br /><br />(1) Unacceptable - When tested, verbally or written, answers with 69% or less accuracy.
...
<br /><br />(1) Unacceptable - Does not know medication protocols. Unable to recognize and treat patient with appropriate medication. Does not check dates and labels.
<br /><br />(4) Acceptable - Follows required protocol in commonly encountered situations. Administers proper medication to patient in a safe and timely manner. Checks dates and labels.
<br /><br />(7) Superior - Follows required procedure in all cases, accurately applying medication protocol and treating patient appropriately. Checks dates and labels and verifies with partner.'/></div>";
																	

		echo $this->Form->input('8t', array('label'=>'Delete?? Knowledge of Pharmacology', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
		...
		echo $this->Form->input('8p', array('label'=>'Delete?? Knowledge of Pharmacology', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='9.  KNOWLEDGE OF PEDIATRIC PROTOCOLS- Evaluates the new employees knowledge of pediatric protocols and has the ability to apply that knowledge to field situations.
-Reflected by Testing-
<br /><br />(1) Unacceptable - When tested, verbally or written, answers with 69% or less accuracy.
...
<br /><br />(7) Superior - When tested, verbally or written, answers with 100% accuracy.
-Reflected in Field Performance-
<br /><br />(1) Unacceptable-  Does not know the elements of pediatric protocols.  Does not recognize an emergent situation versus a non-emergent situation.  Makes mistakes relative to whether or not treatment should be given.

<br /><br />(4) Acceptable- Recognizes commonly encountered pediatric situations and applies appropriate treatment.  Knows difference between when to treat and when not to treat.

<br /><br />(7) Superior- Demonstrates outstanding knowledge of Pediatric Protocols and applies that knowledge to normal and unusual pediatric calls.'/></div>";
																	

		echo $this->Form->input('9t', array('label'=>'Delete?? Knowledge of Pediatric Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
		...
		echo $this->Form->input('9p', array('label'=>'Delete?? Knowledge of Pediatric Protocols', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='10.   PUNCUTALITY / SHIFT CHANGE PROCEDURES - Evaluates the new employees punctuality in reporting for duty.  Evaluates new employee’s conformance to Divisional Standard in regards to uniform and PPE when reporting for duty. Evaluates new employees conformance to Divisional Standards in regards to shift change procedures.(ie. Controlled substance change over, unit report)
<br /><br />(1) Unacceptable – Fails to report for duty at scheduled time. Fails to arrive at work in uniform ready for duty. Fails to follow proper procedures for shift change.
<br /><br />(4) Acceptable – Arrives at work at the assigned time. Reports to work in the proper uniform ready for duty. Follows proper procedures for shift change.
<br /><br />(7) Superior – Arrives at work at least 30 minutes prior to shift change. Volunteers to stay past assigned shift time to help in the event of shift vacancies. Ensures off going and oncoming relief adheres to proper shift change procedures.'/></div>";
																	

		echo $this->Form->input('10', array('label'=>'10 Punctuality / Shift Change Procedures', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='11. EQUIPMENT READINESS- Evaluates the new employees ability to effectively prepare their equipment on a daily basis. Evaluates the new employees ability to restock equipment after each call.
   ...
   <br /><br />(7) Superior- Always prepares equipment no matter what the situation.  Keeps partner informed and determines the best option for equipment readiness.'/></div>";
		...
		echo $this->Form->input('11', array('label'=>'11 Equipment Readiness', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='2. ASSESSMENT / DECISION MAKING – Evaluates the new employees ability to perform a thorough patient assessment, interprets findings accurately, plans an appropriate course of treatment and transports in a timely manner.
...
<br /><br />(7) Superior- Is able to perform a pertinent advanced, comprehensive patient assessment.  Accurately interprets atypical patient presentations.  Anticipates problems and prepares resolutions in advance. Transports in a timely manner.'/></div>";
		...
		echo $this->Form->input('12', array('label'=>'12 Assessment / Decision Making', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='13.  BLS SKILLS- Evaluates the new employees skill in the delivery of Basic Life Support skills to the patient.
...
<br /><br />(7) Superior - Performs in all cases, anticipating needs of patient and care team.'/></div>";
		...
		echo $this->Form->input('13', array('label'=>'13 BLS Skills', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='14.  ALS SKILLS- Evaluates the new employees skill in the delivery of Advanced Life Support skills to the patient.
...
<br /><br />(7) Superior - Follows proper skills in all cases, anticipating needs of patient and care team.'/></div>";
		...
		echo $this->Form->input('14', array('label'=>'14 ALS Skills', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='5.   DRIVING SKILL: NON-EMERGENT - Evaluates the new employees skill in the operation of the emergency vehicle under normal driving conditions.
...
<br /><br />(7) Superior - Sets an example for lawful, courteous driving. Maintains complete control of the vehicle while performing other tasks. Is a superior defensive driver.'/></div>";
		...
		echo $this->Form->input('15', array('label'=>'15 Driving Skills: Non - Emergent', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='16.   DRIVING SKILL: EMERGENT - Evaluates the new employees skill in vehicle operation under emergency situations and in situations calling for other than usual driving skill.
...
<br /><br />(7) Superior - Displays high degree of reflex ability and driving competence. Anticipates driving situations in advance and acts accordingly. Practices defensive techniques. Responds very well relative to the degree of stress present.'/></div>";
		...
		echo $this->Form->input('16', array('label'=>'16 Driving Skills: Emergent', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='17.   ORIENTATION/RESPONSE TO CALLS/MAPPING - Evaluates the new employees awareness of surroundings, ability to find locations and arrive at destination within an acceptable period of time. Ability to navigate.
...
<br /><br />(7) Superior - Remembers locations from previous visits and does not need the map to get there. Is aware of shortcuts and utilizes them to save time. High level of orientation to the district and / or city.'/></div>";
		...
		echo $this->Form->input('17', array('label'=>'17 Orientation: Response to Call / Mapping', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='18.   FIELD PERFORMANCE: STRESS CONDITIONS - Evaluates the new employees ability to perform in moderate and high stress situations. (ie, During calls)
...
<br /><br />(7) Superior - Maintains calm and self-control in even the most extreme situations. Quickly restores control in the situation and takes command. Determines best course of action and takes it.'/></div>";
		...
		echo $this->Form->input('18', array('label'=>'18 Field Performance: Stressful Conditions', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='19.   SELF-INITIATED FIELD ACTIVITY:MAPPING, MEDICAL JOURNAL READING, AMBULANCE INVENTORY AND FAMILIARIZATION, AND PROTOCOL STUDY- Evaluates the new employees interest and ability to initiate EMS related activity. To view same and to act on even low-priority situations.
...
<br /><br />(7) Superior - Seldom misses opportunity to improve, study or learn.'/></div>";
		...
		echo $this->Form->input('19', array('label'=>'19 Self Initiated Field Activity: Protocols/Mapping', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='20.   PARAMEDIC SAFETY: GENERAL - Evaluates the new employees ability to perform EMS tasks without injuring self or others or exposing self or others to unnecessary danger/risk.
...
<br /><br />(7) Superior - Always works safely. Foresees dangerous situations and prepares for them Keeps partner informed and determines the best position for self and partner. Is not overconfident.'/></div>";
		...
		echo $this->Form->input('20', array('label'=>'20 Medic Safety: General', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='21.   PARAMEDIC SAFETY: UNIVERSAL PRECAUTIONS- Evaluates the new employees ability to perform procedures in a safe manner while dealing with patients.
...
<br /><br />(7) Superior - Follows accepted safety procedures with all patients. Uses goggles and mask when appropriate.'/></div>";
		...
		echo $this->Form->input('21', array('label'=>'21 Medic Safety: Universal Precautions', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='22.   CONTROL OF SCENE: VOICE COMMAND - Evaluates the new employees ability to gain and maintain control of situations through verbal command and instruction.
...
<br /><br />(7) Superior - Completely controls with voice tone, word selection, inflection, and the bearing which accompanies what is said. Restores order in even the most trying situations through use of voice.'/></div>";
		...
		echo $this->Form->input('22', array('label'=>'22 Control of Scene: voice Command', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='23.   CONTROL OF SCENE: PHYSICAL SKILL - Evaluates the new employees ability to use proper level of force for the given situation.
...
<br /><br />(7) Superior - Excellent knowledge and ability in the use of restraints. Selects the right amount of force for the given situation. Correct use of soft restraints and chemical restraints.'/></div>";
		...
		echo $this->Form->input('23', array('label'=>'23 Control of Scene: Physical Skill', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='24.   RADIO: APPROPRIATE USE OF EMS RADIO- Evaluates the new employees ability to use the EMS radio in accordance with department policy and procedure.
...
<br /><br />(7) Superior - Always follows proper procedures, adheres to policy. Has superior working knowledge and applies knowledge when using the EMS radio.'/></div>";
		...
		echo $this->Form->input('24', array('label'=>'24 Radio: Appropriate Use of Codes /Procedures', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='25.   RADIO: LISTENS AND COMPREHENDS - Evaluates the new employees ability to pay attention to radio traffic and to understand the information transmitted.
...
<br /><br />(7) Superior - Is aware of own radio traffic and traffic in the surrounding areas. Is aware of traffic in other parts of the city and uses previously transmitted information to advantage.'/></div>";
		...
		echo $this->Form->input('25', array('label'=>'25 Radio: Listens and Comprehends', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='26.   RADIO: ARTICULATION OF TRANSMISSIONS - Evaluates the new employees ability to communicate with others via the EMS radio and hospital pre-arrival reports.
...
<br /><br />(7) Superior - Transmits clearly, calmly, concisely and complete in even the most stressful situations. Transmissions are well thought out and do not have to be repeated. Hospital reports are clear and concise.'/></div>";
		...
		echo $this->Form->input('26', array('label'=>'26 Radio: Articulation of Transmissions', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='27.   SUPPLEMENTARY FORMS – Evaluate new employees ability to properly complete daily supplementary forms necessary to job accomplishment. These forms include but are not limited to Billing/HIPPA, Refusal Form, Intubation Audit.
  ...
  <br /><br />(7) Superior – Consistently completes supplementary forms without assistance. Ensures that forms are attached to the appropriate ECR. Always are very neat and legible. Contain no spelling or grammatical errors'/></div>";
		...
		echo $this->Form->input('27', array('label'=>'27 Supplementary Forms', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='28.   REPORT WRITING: ECR – Evaluates the new employees’ ability to complete an Electronic Call Report for each call response in a detailed               and organized manner.
...
<br /><br />(7) Superior – Documents in a well formatted manner as well as showing a detailed focused exam of the patient complaint  (ie OPQRST for chest pain complaint)'/></div>";
		...
		echo $this->Form->input('28', array('label'=>'28 Report Writing: ECR', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='29.   REPORT WRITING: GRAMMAR/SPELLING/NEATNESS - Evaluates the new employees ability to follow proper rules for English and spelling.<br /><br />
...
(7) Superior - Reports are very neat, legible and well organized. Contain no spelling or grammatical errors.'/></div>";
		...
		echo $this->Form->input('29', array('label'=>'29 Report Writing: Grammar / Spelling', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='30.   REPORT WRITING: APPROPRIATE TIME USED - Evaluates the new employees efficiency relative to the amount of time taken to write a report.<br /><br />
...
<br /><br />(7) Superior - Consistently completes reports timely and efficiently.'/></div>";
		...
		echo $this->Form->input('30', array('label'=>'30 Report Writing: Appropriate Time Used', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='31.   WITH PATIENT/CITIZENS IN GENERAL - Evaluates the new employees ability to interact with citizens (including patient, family and bystanders) in an appropriate, efficient manner.
...
<br /><br />(7) Superior - Is very much at ease with citizen contacts. Quickly establishes rapport and leaves people with feeling that the EMS employee was interested in serving them. Is objective in all contacts. Excellent NON-VERBAL skills.'/></div>";
		...
		echo $this->Form->input('31', array('label'=>'31 With Patient / Citizens in General', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='32.   WITH  DEPARTMENT MEMBERS, PEERS AND OTHER PUBLIC SAFETY AGENCIES (Specify) -Evaluates the new employees ability to effectively interact with department members, peers and other public safety agencies regardless of  ranks and capacities.
...
<br /><br />(7) Superior - Is at ease in contact with all, including superiors. Understands superiors' responsibilities, respects and supports their position. Peer group leader. Actively assists others.  TEAM PLAYER with all public safety agencies.'/></div>";
		...
		echo $this->Form->input('32', array('label'=>'32 With Department Members, Peers and Other PS', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
																		...
																		'7'=>'7 - Superior',
																		'8'=>'N.O.')));
		echo "<div class='helpimg'><img src='../img/questionmark.png' title='3. HOSPTIAL STAFF - Evaluates new employees ability to effectively interact with hospital staff.
...
<br /><br />(7) Superior - Consistently has a strong rapport with hospital staff. Actively pursues role of patient advocate. (ie. patient placement)'/></div>";
		...
		echo $this->Form->input('33', array('label'=>'33 With Hospital Staff', 'empty'=>'--------------------','class'=>'hradio', 'type'=>'select', 'options' => array(
																		'1'=>'1 - Unacceptable',
																		'2'=>'2',
																		'3'=>'3',
																		'4'=>'4 - Acceptable',
