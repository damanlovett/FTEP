...
<div class="documentations index">
	...
	<h2><?php __('Trainee Documentations');?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('observation_id');?></th>
			<th><?php echo $this->Paginator->sort('Date','ob_date');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $time->format('m/d/y', $documentation['Documentation']['ob_date']); ?>&nbsp;</td>
